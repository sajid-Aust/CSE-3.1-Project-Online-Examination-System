      ...
      <div class="wrapper">
          <div class="container-fluid">
              <div class="row">
                  ...
                  <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 col-xs-12">
                          <form class="form-container" action="update_admin.php" method="post">
                          
                                  <h1 style="text-align: center; font-weight: 600 ; color:darkorange">Admin</h1>
                                  <?php include('error.php') ?>
                                  <div class="form-group">
                                    <label for="exampleInputName" style="font-size: 1.8rem; ">New Username</label>
                                    <input type="text" class="form-control" name="adminname" id="exampleInputName" placeholder="Username" required>
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleInputPassword" style="font-size: 1.8rem; ">New Password</label>
